...
- 2026-02-08: Tenant isolation hardening: findUnique scoping, update/delete guards, FK tenant consistency checks, auth tenant validation, bypass context, tenant error handling, and updated PRD.
