    ...
    return (
        <div className="p-8 space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Şube Yönetimi</h1>
                    <p className="text-sm text-gray-500 font-medium mt-1">Acentelik şubelerini ve varsayılan ayarları yönetin</p>
                </div>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Yeni Şube</h3>
                                <p className="text-xs text-gray-400 font-medium tracking-wide">Sisteme yeni bir şube tanımlayın</p>
                            </div>
                        </div>

                        <form onSubmit={handleCreate} className="space-y-5">
                            <div className="space-y-2">
                                <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Şube Adı</label>
                                <Input
                                    value={newBranchName}
                            ...
                            <div className="space-y-2">
                                <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Varsayılan Komisyon Oranı</label>
                                <div className="relative">
                                    <Input
                                        ...
                                        className="h-12 bg-gray-50 border-none rounded-xl focus:ring-4 focus:ring-emerald-500/5 transition-all pl-10 text-sm font-bold"
                                        required
                                    />
                                    <TrendingUp size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-emerald-500" />
                                </div>
                                <p className="text-[10px] text-gray-400 font-medium mt-1 ml-1 text-right">0.10 formatı %10 anlamına gelir.</p>
                            </div>
                    ...
                    {/* Quick Stat */}
                    <div className="bg-emerald-600 p-8 rounded-[32px] text-white relative overflow-hidden shadow-xl shadow-emerald-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {loading ? (
                            ...
                            <div className="col-span-full bg-white p-20 rounded-[32px] border border-dashed border-gray-200 text-center">
                                ...
                                <p className="text-gray-400 font-bold">Şube bulunamadı.</p>
                            </div>
                        ) : filteredBranches.map((branch) => (
                            <div key={branch.id} className="bg-white p-6 rounded-[24px] border border-gray-100 shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
                                ...
                                <div className="mt-6 flex items-center justify-between text-[10px] font-bold text-gray-400 uppercase tracking-widest border-t border-gray-50 pt-4 relative z-10">
                                    ...
                                    <span className="text-gray-300 group-hover:text-emerald-500 transition-colors">Yönet &rarr;</span>
                                </div>
                            </div>
                        ))}
                    </div>
                        ...
                        <div className="p-8">
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900">Şube Düzenle</h3>
                                        <p className="text-[11px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Ayarları Güncelleyin</p>
                                    </div>
                                </div>
                                <button
                            ...
                            <form onSubmit={handleUpdate} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest ml-1">Komisyon Oranı</label>
                                    <div className="relative">
                                        <Input
                                            type="number"
                                            step="0.01"
                                    ...
                                    <p className="text-[10px] text-gray-400 font-medium ml-1">Örn: 0.15 (%15)</p>
                                </div>
