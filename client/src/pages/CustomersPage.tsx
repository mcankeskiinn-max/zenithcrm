    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Müşteri Portföyü</h1>
                    <p className="text-sm text-gray-500 font-medium mt-1">Sistemdeki tüm müşteriler ve özet bilgileri</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    ...
                    <div
                        key={customer.id}
                        className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group cursor-pointer"
                    ...
                    >
                        <div className="flex items-start justify-between mb-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-gray-900 group-hover:text-emerald-600 transition-colors uppercase tracking-tight">{customer.name}</h3>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">Müşteri ID: {customer.id.slice(0, 8)}</p>
                                </div>
                            </div>
                            <div className="w-8 h-8 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <div className="p-3 bg-gray-50 rounded-2xl">
                                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1">Poliçe Sayısı</p>
                                <p className="text-lg font-black text-gray-900">{customer._count.sales}</p>
                            </div>
                            <div className="p-3 bg-gray-50 rounded-2xl">
                                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1">Açık Görevler</p>
                                <p className="text-lg font-black text-gray-900">{customer._count.tasks}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2 text-[10px] font-bold text-gray-400 pt-2">
                                <Calendar size={12} />
