...
import { getCustomers, getCustomerProfile, getCustomerAccountSuggestions, createCustomer, updateCustomer, deleteCustomer } from '../controllers/customer.controller';
...
router.get('/:id/account-suggestions', getCustomerAccountSuggestions);
router.post('/',
    ...
    body('naceCode').optional({ nullable: true, checkFalsy: true }).isString().trim().matches(/^[0-9.]{4,16}$/),
